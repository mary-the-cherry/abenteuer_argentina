        ...
        var n = {
          ...
          onInitialise: function (e) {
            ...
            if (type == 'opt-in' && didConsent) {
              ...
              console.log(' 1 Ich nehme Cookies');
            }
            if (type == 'opt-out' && !didConsent) {
              window['ga-disable-UA-175425475-1'] = true;
              console.log('1 Keine Cookies fer mich');
            }
          },
          onStatusChange: function (e, t) {
            ...
            if (type == 'opt-in' && didConsent) {
              window['ga-disable-UA-175425475-1'] = false;
              console.log('2 Ich nehme Cookies');
            }
            if (type == 'opt-out' && !didConsent) {
              window['ga-disable-UA-175425475-1'] = true;
              console.log('2 Keine Cookies fer mich');
            }
          },
